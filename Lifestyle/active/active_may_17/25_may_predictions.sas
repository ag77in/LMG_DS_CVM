  ...
  data SPDTMP7.VB_Apr_ALL_TN_ITM_REV_AE (Compress=yes);
      set sascrm.TN_ITM_REV_AE ;
		where TXN_DT_WID >= 20160501 and TXN_DT_WID<= 20170431 and TRANSACTION_TYPE = "Purchase" and units >= 0 and revenue_aed >= 0 and Retail_cost_1_AED >= 0 and Retail_cost_2_AED>= 0 ;
...
data SPDTMP7.VB_Apr_LS_TN_ITM_REV_AE_ (Compress=yes);
      set sascrm.TN_ITM_REV_AE ;
		where TXN_DT_WID >= 20160501 and TXN_DT_WID<= 20170431 and LMG_CONCEPT_NAME = "Lifestyle" and TRANSACTION_TYPE = "Purchase" and units >= 0 and revenue_aed >= 0 and Retail_cost_1_AED >= 0 and Retail_cost_2_AED>= 0 ;

	   if TXN_DT_WID>= 20160501 and TXN_DT_WID<= 20160731 then visit_flag = 4 ;
	   else if TXN_DT_WID> 20160731 and TXN_DT_WID<= 20161031 then visit_flag = 3 ;
	   else if TXN_DT_WID> 20161031 and TXN_DT_WID<= 20170131 then visit_flag = 2; 
	   else if TXN_DT_WID> 20170131 and TXN_DT_WID<= 20170431 then visit_flag = 1; 
	   date = INPUT(PUT(TXN_DT_WID,8.),YYMMDD8.); 
	   format date ddmmyys10.;
  run;
  ...
  data SPDTMP7.VB_Apr_SH_TN_ITM_REV_AE_ (Compress=yes);
      set sascrm.TN_ITM_REV_AE ;
		where TXN_DT_WID >= 20160501 and TXN_DT_WID<= 20170431 and LMG_CONCEPT_NAME = "Splash" and TRANSACTION_TYPE = "Purchase" and units >= 0 and revenue_aed >= 0 and Retail_cost_1_AED >= 0 and Retail_cost_2_AED>= 0 ;
...
data SPDTMP7.VB_Apr_HC_TN_ITM_REV_AE_ (Compress=yes);
      set sascrm.TN_ITM_REV_AE ;
		where TXN_DT_WID >= 20160501 and TXN_DT_WID<= 20170431 and LMG_CONCEPT_NAME = "Home center" and TRANSACTION_TYPE = "Purchase" and units >= 0 and revenue_aed >= 0 and Retail_cost_1_AED >= 0 and Retail_cost_2_AED>= 0 ;
...
data SPDTMP7.VB_Apr_HB_TN_ITM_REV_AE_ (Compress=yes);
      set sascrm.TN_ITM_REV_AE ;
		where TXN_DT_WID >= 20160501 and TXN_DT_WID<= 20170431 and LMG_CONCEPT_NAME = "Home Box" and TRANSACTION_TYPE = "Purchase" and units >= 0 and revenue_aed >= 0 and Retail_cost_1_AED >= 0 and Retail_cost_2_AED>= 0 ;
...
data SPDTMP7.VB_Apr_BS_TN_ITM_REV_AE_ (Compress=yes);
      set sascrm.TN_ITM_REV_AE ;
		where TXN_DT_WID >= 20160501 and TXN_DT_WID<= 20170431 and LMG_CONCEPT_NAME = "Babyshop" and TRANSACTION_TYPE = "Purchase" and units >= 0 and revenue_aed >= 0 and Retail_cost_1_AED >= 0 and Retail_cost_2_AED>= 0 ;
...
where txn_dt_wid>=20160801 and txn_dt_wid<=20170431 ;
...
set SPDTMP7.VB_Apr_ALL_TN_ITM_REV_AE(keep= lmg_mem_card_number lmg_concept_name  txn_dt_wid revenue_aed invoice_number units item_code base_points_accrued date);
where txn_dt_wid>=20161101 and txn_dt_wid<=20170431 ;
...
set SPDTMP7.VB_Apr_ALL_TN_ITM_REV_AE(keep= lmg_mem_card_number lmg_concept_name txn_dt_wid revenue_aed invoice_number units item_code base_points_accrued date);
where txn_dt_wid>=20170101 and txn_dt_wid<=20170431 ;
run;
...
else if age_group = "NA" and Rand_no > 0.0049 and Rand_no <= 0.0155 then age_group = "11-18";
else if age_group = "NA" and Rand_no > 0.0155 and Rand_no <= 0.1042 then age_group = "19-25";
else if age_group = "NA" and Rand_no > 0.1042 and Rand_no <= 0.5087 then age_group = "26-35";
else if age_group = "NA" and Rand_no > 0.5087 and Rand_no <= 0.9175 then age_group = "36-50";
...
proc logistic  
	 ...
	 Out  = SPDTMP7.VB_CUS_TN_ITM_REV_AE_Mayscr;
run;   
