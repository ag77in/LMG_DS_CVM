...
data spdtmp7.VB_WB_May_LMG_ALL_TXN(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
...
proc sql;
create table spdtmp7.VB_WB_May_LMG_ALL_TXN (compress=yes) as
...
from spdtmp7.VB_WB_May_LMG_ALL_TXN
group by LMG_MEM_CARD_Number;
quit;

data spdtmp7.VB_WB_May_LMG_ALL_TXN(compress=yes);
set spdtmp7.VB_WB_May_LMG_ALL_TXN;
...
data spdtmp7.VB_WB_May_LMG_3_TXN(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_WB_May_LS_TXN;
...
proc sql;
create table spdtmp7.VB_WB_May_LMG_3_TXN(compress=yes) as
select  LMG_mem_card_number, 
...
from spdtmp7.VB_WB_May_LMG_3_TXN
...
data spdtmp7.VB_WB_May_LMG_3_TXN(compress=yes);
set spdtmp7.VB_WB_May_LMG_3_TXN;
...
data spdtmp7.VB_WB_May_LMG_6_TXN(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_WB_May_LS_TXN;
...
proc sql;
create table spdtmp7.VB_WB_May_LMG_6_TXN(compress=yes) as
...
from spdtmp7.VB_WB_May_LMG_6_TXN
...
data spdtmp7.VB_WB_May_LMG_6_TXN(compress=yes);
set spdtmp7.VB_WB_May_LMG_6_TXN;
...
data spdtmp7.VB_WB_May_LMG_9_TXN(compress=yes keep=lmg_mem_card_number lmg_concept_name txn_dt_wid lmg_x_dept_cd revenue_aed invoice_number units item_code base_points_accrued retail_cost_1_aed retail_cost_2_aed date);
set spdtmp7.VB_WB_May_LS_TXN;
...
proc sql;
create table spdtmp7.VB_WB_May_LMG_9_TXN(compress=yes) as
select distinct LMG_mem_card_number, 
...
from spdtmp7.VB_WB_May_LMG_9_TXN
...
data spdtmp7.VB_WB_May_LMG_9_TXN(compress=yes);
set spdtmp7.VB_WB_May_LMG_9_TXN;
...
proc sql; 
create table spdtmp7.VB_WB_May_LMG_TXN_Overall (compress=yes) as
select a.*,b.*,c.*,d.* from spdtmp7.VB_WB_May_LMG_ALL_TXN a 
left join  spdtmp7.VB_WB_May_LMG_3_TXN b on a.Lmg_mem_card_number=b.LMG_mem_card_number
left join spdtmp7.VB_WB_May_LMG_6_TXN c on a.LMG_mem_card_number=c.LMG_mem_card_number
left join spdtmp7.VB_WB_May_LMG_9_TXN d on a.LMG_mem_card_number=d.LMG_mem_card_number;
quit;



proc delete data=spdtmp7.VB_WB_May_LMG_3_TXN;
proc delete data=spdtmp7.VB_WB_May_LMG_6_TXN;
proc delete data=spdtmp7.VB_WB_May_LMG_9_TXN;